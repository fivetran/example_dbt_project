...
# Step 1: Add the Fivetran Platform Connector to your list of connections
The [platform connector](https://fivetran.com/docs/logs/fivetran-platform#fivetranplatformconnector) is a FREE connector that ships logs related to your Fivetran account to your destination. Not only is it a great way to have some visibility into your account, but we can see how Fivetran Transformations turn the logs into actionable insights!

# Step 2: Add the Fivetran Platform Connector as a source
...
# Step 6: Add custom SQL (optional) 
...
# Step 7: Connect your new repository to Fivetran
